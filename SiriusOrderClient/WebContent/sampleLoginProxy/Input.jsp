...
<TR>
<TD ALIGN="left" CLASS="nullcol"><input type="checkbox" name="email16null" value="email16null"></TD>
<TD COLSPAN="1" ALIGN="LEFT" CLASS="headingcol">email:</TD>
...
<TR><TD ALIGN="LEFT" CLASS="headingcol">null?</TD></TR>
<TR>
<TD ALIGN="left" CLASS="nullcol"><input type="checkbox" name="password18null" value="password18null"></TD>
<TD COLSPAN="1" ALIGN="LEFT" CLASS="headingcol">password:</TD>
