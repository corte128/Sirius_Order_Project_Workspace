...
<LI><A HREF="Input.jsp?method=13&methodName=getEmployeeByCredentials" TARGET="inputs">getEmployeeByCredentials(java.lang.String,java.lang.String)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleLoginProxyid.getClass())) {
%>
